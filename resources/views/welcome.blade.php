        ...
        <header class="atlas-nav sticky top-0 z-40">
            <div class="atlas-nav-inner max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ route('dashboard') }}" class="atlas-btn-primary">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="inline-flex items-center px-3.5 py-2 text-xs font-display uppercase tracking-wider text-[#8fa89c] hover:text-white transition">
                                {{ __('Log in') }}
                            </a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="atlas-btn-primary">
                                    {{ __('Sign up') }}
                                </a>
                            @endif
                        @endauth
