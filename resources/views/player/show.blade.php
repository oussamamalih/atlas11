<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            @if (session('status'))
                <div class="font-medium text-sm text-[#10b981] bg-[#0d2919] border border-[#1a4030] border-l-4 border-l-[#10b981] p-4 rounded flex items-center">
            ...
            @if (session('error'))
                <div class="font-medium text-sm text-[#ef4444] bg-[#0d2919] border border-[#1a4030] border-l-4 border-l-[#ef4444] p-4 rounded flex items-center">
                    <svg class="w-5 h-5 me-2 text-[#ef4444] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
