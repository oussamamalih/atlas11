            ...
            <form method="POST" action="{{ route('scout.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="role_title" name="role_title" type="text" value="{{ old('role_title') }}" required
                            class="w-full bg-[#0d2919] border border-[#1a4030] text-white rounded px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#10b981] focus:border-transparent" />
                        @error('role_title')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input id="experience_years" name="experience_years" type="number" value="{{ old('experience_years') }}"
                            class="w-full bg-[#0d2919] border border-[#1a4030] text-white rounded px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#10b981] focus:border-transparent" />
                ...
                <div>
                    ...
                    <textarea id="bio" name="bio" rows="4"
                        class="w-full bg-[#0d2919] border border-[#1a4030] text-white rounded px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#10b981] focus:border-transparent">{{ old('bio') }}</textarea>
                    @error('bio')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
